...
public class TransactionLogAppendAndRotateStressIT
{
    ...
    @Rule
    public final RuleChain chain = RuleChain.outerRule( directory ).around( life );
    ...
    public void shouldKeepTransactionsIntactWhenConcurrentlyRotationAndAppending() throws Throwable
    {
        ...
        TransactionAppender appender = life.add( new BatchingTransactionAppender( logFile, rotation, metadataCache,
    ...
    private Runnable endAfterMax( int time, TimeUnit unit, AtomicBoolean end )
    {
        return () ->
        {
